...
complicationsInMenOlderThan60 <- plot_ly(data, x = ~x, y = ~y1, type = 'bar', name = 'Without Complications', marker = list(color = '#546FBF'))
complicationsInMenOlderThan60 <- complicationsInMenOlderThan60 %>% add_trace(y = ~y2, name = 'With Complications', marker = list(color = '#F24B4B'))
