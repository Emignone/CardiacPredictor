...
We have analyzed the given dataset from different perspectives. We started by researching on the subject and becoming familiar with the different concepts and pathologies. After understanding the subject, we proceeded to apply the knowledge, both in the analysis, the interpretation and finally in the predictor of the dataset.
</p>
<p><br></p>
